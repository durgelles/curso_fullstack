...
"""
# pedir por pantalla el si es chico o chica y el nombre
genero=input("diga si es chico o chica: ")
nombre=input("ingrese su nombre: ")
nombre=nombre.lower()

if genero=="chica":
    if nombre[0] in "efghijklm":
        print(f"{nombre} perteneces al grupo A ")
    else:
        print(f"{nombre} perteneces al grupo B")
else:
    if nombre[0] in "abcdefgh" or nombre[0] in "rstuvwxyz":
        print(f"{nombre} perteneces al grupo A")
    else:
        print(f"{nombre} perteneces al grupo B ")
